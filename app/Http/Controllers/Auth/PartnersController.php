...
class PartnersController extends Controller
{
    ...
    /**
     * Login partner and create token
     * 
     * @param Request $request
     * @return JsonResponse
     */
    public function login(Request $request): JsonResponse
    {
        ...
        // First check if user exists and is a partner
    ...
    /**
     * Logout partner (Invalidate the token)
     * 
     * @return JsonResponse
     */
    ...
    public function updateBusinessInfo(Request $request): JsonResponse
    {
        ...
        try {
            $request->validate([
                ...
                'business_name.max' => 'The business name cannot exceed 100 characters.',
                ...
                'business_registration_number.max' => 'The business registration number cannot exceed 50 characters.',
        ...
        try {
            $user = Auth::user();
            $user->partner()->update($request->only([
                'business_name',
            ...
            return response()->json([
                ...
                'data' => [
                    'business_info' => $user->partner
                ]
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'message' => 'Business information update failed.',
                'errors' => [
                    'general' => ['An error occurred while updating business information. Please try again.']
                ]
            ], 500);
        }
    }
    ...
    public function getBusinessInfo(): JsonResponse
    {
        try {
            ...
            return response()->json([
                ...
                'errors' => [
                    'general' => ['An error occurred while retrieving business information. Please try again.']
                ]
            ], 500);
        }
    }
    ...
    public function forgotPassword(Request $request): JsonResponse
    {
        ...
        if (!$user) {
            return response()->json([
                ...
                'errors' => [
                    'email' => ['No partner account found with this email.']
                ]
            ], 404);
        }
